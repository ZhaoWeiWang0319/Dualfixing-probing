...
struct HighsMipSolverData {
  ...
  // new statistics
  int64_t num_firstround_probing_bchgs;
  int64_t num_firstround_probing_nfix;
  int64_t num_firstround_probing_nTotalVars;
  int64_t num_firstround_probing_propagate_iter;
  int64_t num_firstround_probing_candidates;
  int64_t num_firstround_probing_max_iter;
  HighsInt num_call_probing;
  HighsInt num_reduction_limit;
  ...
  HighsMipSolverData(HighsMipSolver& mipsolver)
      : mipsolver(mipsolver),
        ...
        num_disp_lines(0),
        num_firstround_probing_bchgs(0),
        num_firstround_probing_nfix(0),
        num_firstround_probing_nTotalVars(0),
        num_firstround_probing_propagate_iter(0),
        num_firstround_probing_candidates(0),
        num_firstround_probing_max_iter(0),
        num_call_probing(0),
        num_reduction_limit(0),
        numImprovingSols(0),
